...
generators.mqttListener = {
   ...
   */
  getFileName (name) {
    name = name.replace(/mqttlistener/ig, '')
  ...
  getFilePath (name, options) {
    return path.join(options.appRoot, options.appDir, options.dirs.mqttListeners, this.getFileName(name)) + '.js'
  }
}
